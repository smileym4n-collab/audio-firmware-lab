...
- Serial rename command:
  ...
  - device saves the new name; press RESET/power-cycle to apply.
...
- BTI2S now prints setup checkpoint logs (`init encoder`, `load BT name`, `start A2DP`, `apply I2S`) to help diagnose startup/reset issues.
