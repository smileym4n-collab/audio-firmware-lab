...
- Displays:
  ...
  - firmware probes LCD addresses `0x27` then `0x3F` at startup and uses the one that responds
...
Firmware explicitly configures `PB1` as high-impedance analog input (pull-up disabled, digital input buffer disabled).
